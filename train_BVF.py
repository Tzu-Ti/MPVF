...
from dataset import pyramid_dataset_origin as pyramid_dataset
from models import BVF
from criterion import *
from utils import backwardwarping3D, flow_visualize, weights_init, Visdom
...
def parse():
    ...
    # dataset information
    parser.add_argument('--train_folder', default='data/training-2_processed')
    parser.add_argument('--test_folder', default='data/testing-2_4')
    # training hyper-parameter
    parser.add_argument('--model_name', required=True)
    parser.add_argument('-b', '--batch_size', default=2, type=int)
    parser.add_argument('-l', '--lr', default=1e-4,  type=float)
    parser.add_argument('-e', '--epochs', default=1000, type=int)
    parser.add_argument('--test_t', default=0.5, type=float)
    # device setting
...
class Model_factory():
    def __init__(self, args):
        ...
        # Data loader
        trainDataset = pyramid_dataset.dataset(self.args.train_folder, 'random', train=True)
        ...
        self.testDataset = pyramid_dataset.dataset(self.args.test_folder, args.test_t, train=False)
    ...
    def train(self, e, vis):
        ...
        for idx, (ED, ES, Et, t) in enumerate(pbar):
    ...
    def test(self, e, vis):
        ...
        vis.Images(ED=ED_, ES=ES_, Et=Et_)
        vis.Images(Et_D=Et_D_, Et_S=Et_S_)
        vis.Images(Flowt0=flow_colorst0, Flowt1=flow_colorst1)
...
def main():
    ...
    # visdom
    vis = Visdom(env=args.model_name, port=6006)
