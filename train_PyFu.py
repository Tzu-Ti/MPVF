...
from utils import generate_vimg, backwardwarping3D, flow_visualize, weights_init
...
def parse():
    ...
    # dataset information
    parser.add_argument('--train_folder', default='data/training-1_processed')
    parser.add_argument('--test_folder', default='data/testing-1_4')
...
class Model_factory():
    def __init__(self, args):
        ...
        # Data loader
        InterDataset = pyramid_dataset.dataset(self.args.train_folder, 'random', train=True)
        self.train_loader = DataLoader(dataset=InterDataset,
                                       batch_size=self.args.batch_size,
                                       shuffle=True, 
                                       num_workers=self.args.num_workers)
        
        self.testDataset = pyramid_dataset.dataset(self.args.test_folder, 0.5, train=False)
